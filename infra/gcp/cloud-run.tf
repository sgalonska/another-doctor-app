  ...
  template {
    ...
    containers {
      ...
      env {
        ...
        value = "https://app.another.doctor,https://*.run.app,http://localhost:3000"
      }
...
# Workers service - temporarily commented out
...
# Qdrant vector database service - temporarily commented out  
...
# Separate bucket for Qdrant storage - temporarily commented out
...
# Removed static frontend bucket - now using Cloud Run instead

# Private access for internal services - temporarily commented out
