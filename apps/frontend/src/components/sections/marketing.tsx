        ...
        <div className="container">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/"
                className="inline-flex items-center justify-center h-11 rounded-md px-8 font-medium transition-all duration-200 bg-brand-teal text-white hover:bg-brand-teal-dark focus:ring-2 focus:ring-offset-2 focus:ring-brand-teal/20"
              >
                Start Diagnosis Analysis
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center h-11 rounded-md px-8 font-medium transition-all duration-200 border-2 border-brand-teal text-brand-teal hover:bg-brand-teal hover:text-white focus:ring-2 focus:ring-offset-2 focus:ring-brand-teal/20"
              >
                Contact Sales
              </Link>
            </div>
