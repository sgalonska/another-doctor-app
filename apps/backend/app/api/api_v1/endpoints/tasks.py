...
from app.core.dependencies import get_queue_service, QueueService
...
async def analyze_diagnosis(
    ...
    try:
        task_id = queue_service.client.enqueue_diagnosis_analysis(
            case_id=case_id,
            file_path=file_path,
            user_id=user_id,
...
async def match_specialists(
    ...
    try:
        task_id = queue_service.client.enqueue_specialist_matching(
            case_id=case_id,
...
async def send_notification(
    ...
    try:
        task_id = queue_service.client.enqueue_notification(
            user_id=user_id,
